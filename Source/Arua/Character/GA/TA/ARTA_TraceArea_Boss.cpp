...
#include "Character/GA/TA/ARTA_TraceArea_Boss.h"
...
AARTA_TraceArea_Boss::AARTA_TraceArea_Boss()
{
}

void AARTA_TraceArea_Boss::StartTargeting(UGameplayAbility* Ability)
{
...
void AARTA_TraceArea_Boss::ConfirmTargetingAndContinue()
{
	if (SourceActor)
	{
...
FGameplayAbilityTargetDataHandle AARTA_TraceArea_Boss::MakeTargetData() const
{
	ACharacter* Character = CastChecked<ACharacter>(SourceActor);

	// 공격 범위 설정: 플레이어 주변의 반지름
	const float AttackRadius = 800.0f;
