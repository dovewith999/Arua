...
#include "Character/GA/TA/ARTA_Trace_Boss.h"
...
AARTA_Trace_Boss::AARTA_Trace_Boss()
{
}

void AARTA_Trace_Boss::StartTargeting(UGameplayAbility* Ability)
{
...
void AARTA_Trace_Boss::ConfirmTargetingAndContinue()
{
	if (SourceActor)
	{
...
FGameplayAbilityTargetDataHandle AARTA_Trace_Boss::MakeTargetData() const
{
